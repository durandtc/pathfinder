...

{
  ...
  "career_choice_rationale": "2 sentences: why these 3 specific careers ranked above all others. Reference a pattern you found in their assessment data (e.g. 'Your investigative interests combined with strong leadership energy point toward impact-driven fields rather than individual contributor roles').",
  ...
  "subject_or_next_steps_advice": "${schoolLearner ? 'Use markdown formatting to structure subject advice clearly: bold the career names (e.g. **Rank 1: [Career]**), list required subjects as bullets, and create a comparison table if helpful. Reference all three careers and current academic performance. End with ACTION ITEMS: 4 numbered items, specific and doable (e.g. 1. Arrange to shadow [role] at [specific place], 2. Talk to [teacher/parent] about [specific topic], 3. Register for [course], 4. [concrete next step]).' : 'Concrete 3-5 step action plan tailored to this person\'s stage — upskilling, applications, networking, or transition steps. Use bullets and bold for clarity. End with exactly 4 ACTION ITEMS.'}",
