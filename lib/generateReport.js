...
Produce ONLY a valid JSON object — no markdown, no preamble, no text outside the JSON:

{
  ...
  "subject_or_next_steps_advice": "${schoolLearner ? 'Specific subject combination advice referencing all three careers and current academic performance' : 'Concrete 3-5 step action plan tailored to this person\'s stage — upskilling, applications, networking, or transition steps'}",
