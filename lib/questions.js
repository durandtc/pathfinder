...
export const QUESTIONS = [
  // ── SECTION 1: INTERESTS (RIASEC) ── 21 questions (15 original + 6 new rephrased for consistency check) ──────────
  // Questions are shuffled (not grouped by type) to prevent pattern detection by responders
  // New questions marked with [CONSISTENCY] measure internal reliability of RIASEC type assessment

  { section: 0, type: 'scale', riasec: 'R', stages: ['grade_8', 'grade_9', 'grade_10', 'grade_11', 'grade_12'], text: 'I enjoy working with my hands — building, fixing, or making things.' },
  { section: 0, type: 'scale', riasec: 'I', stages: ['grade_8', 'grade_9', 'grade_10', 'grade_11', 'grade_12'], text: 'I enjoy investigating problems and figuring out how and why things work.' },
  { section: 0, type: 'scale', riasec: 'A', stages: ['grade_8', 'grade_9', 'grade_10', 'grade_11', 'grade_12'], text: 'I enjoy creative activities like art, music, writing, or design.' },
  { section: 0, type: 'scale', riasec: 'S', stages: ['grade_8', 'grade_9', 'grade_10', 'grade_11', 'grade_12'], text: 'I enjoy helping, teaching, or caring for other people.' },
  { section: 0, type: 'scale', riasec: 'E', stages: ['grade_8', 'grade_9', 'grade_10', 'grade_11', 'grade_12'], text: 'I enjoy leading projects and persuading or motivating others.' },
  { section: 0, type: 'scale', riasec: 'C', stages: ['grade_8', 'grade_9', 'grade_10', 'grade_11', 'grade_12'], text: 'I prefer tasks with clear rules, structure, and measurable outcomes.' },
  { section: 0, type: 'scale', riasec: 'R', stages: ['grade_8', 'grade_9', 'grade_10', 'grade_11', 'grade_12'], text: 'I prefer working with tools, machines, or physical equipment rather than paperwork.' },
  { section: 0, type: 'scale', riasec: 'I', stages: ['grade_8', 'grade_9', 'grade_10', 'grade_11', 'grade_12'], text: 'I like science subjects and understanding how the natural world works.' },
  { section: 0, type: 'scale', riasec: 'A', stages: ['grade_8', 'grade_9', 'grade_10', 'grade_11', 'grade_12'], text: 'I often come up with new and original ideas.' },
  { section: 0, type: 'scale', riasec: 'S', stages: ['grade_8', 'grade_9', 'grade_10', 'grade_11', 'grade_12'], text: 'Making a positive difference in other people\'s lives is very important to me.' },
  { section: 0, type: 'scale', riasec: 'E', stages: ['grade_8', 'grade_9', 'grade_10', 'grade_11', 'grade_12'], text: 'I feel energised when I am in charge of a project or team.' },
  { section: 0, type: 'scale', riasec: 'R', stages: ['grade_8', 'grade_9', 'grade_10', 'grade_11', 'grade_12'], text: 'I enjoy outdoor activities or working in a physical environment.' },
  { section: 0, type: 'scale', riasec: 'I', stages: ['grade_8', 'grade_9', 'grade_10', 'grade_11', 'grade_12'], text: 'I ask a lot of questions and enjoy researching topics in depth.' },
  { section: 0, type: 'scale', riasec: 'A', stages: ['grade_8', 'grade_9', 'grade_10', 'grade_11', 'grade_12'], text: 'I like expressing myself through creative projects.' },
  { section: 0, type: 'scale', riasec: 'S', stages: ['grade_8', 'grade_9', 'grade_10', 'grade_11', 'grade_12'], text: 'I find it easy to understand and empathise with how others feel.' },
  { section: 0, type: 'scale', riasec: 'R', stages: ['grade_8', 'grade_9', 'grade_10', 'grade_11', 'grade_12'], text: 'Working with my hands to create or repair things is something I naturally gravitate toward. [CONSISTENCY]' },
  { section: 0, type: 'scale', riasec: 'I', stages: ['grade_8', 'grade_9', 'grade_10', 'grade_11', 'grade_12'], text: 'I find myself constantly curious about understanding why things work the way they do. [CONSISTENCY]' },
  { section: 0, type: 'scale', riasec: 'A', stages: ['grade_8', 'grade_9', 'grade_10', 'grade_11', 'grade_12'], text: 'Expressing my creativity and original ideas through a project is deeply satisfying to me. [CONSISTENCY]' },
  { section: 0, type: 'scale', riasec: 'S', stages: ['grade_8', 'grade_9', 'grade_10', 'grade_11', 'grade_12'], text: 'I want to be in a career where I work directly with and help people. [CONSISTENCY]' },
  { section: 0, type: 'scale', riasec: 'E', stages: ['grade_8', 'grade_9', 'grade_10', 'grade_11', 'grade_12'], text: 'Taking initiative and being in charge of a project or team energizes me. [CONSISTENCY]' },
  { section: 0, type: 'scale', riasec: 'C', stages: ['grade_8', 'grade_9', 'grade_10', 'grade_11', 'grade_12'], text: 'I like having clear structure and knowing precisely what is expected of me. [CONSISTENCY]' },

  // ── SECTION 2: VALUES ── 7 questions ───────────────────────
  { section: 1, type: 'choice', stages: ['grade_8', 'grade_9', 'grade_10', 'grade_11', 'grade_12'], text: 'Which type of task sounds most appealing to you?', options: ['Designing or building something physical (a structure, product, or machine)', 'Diagnosing a problem or doing scientific research', 'Writing, illustrating, or creating original content', 'Coaching, mentoring, or supporting another person'] },
  { section: 1, type: 'choice', stages: ['grade_8', 'grade_9', 'grade_10', 'grade_11', 'grade_12'], text: 'What kind of workplace would you most prefer?', options: ['A workshop, construction site, lab, or outdoors', 'A research institution, hospital, or technical office', 'A creative studio, agency, or media company', 'A school, clinic, NGO, or community setting'] },
  ...
  { section: 1, type: 'choice', stages: ['grade_8', 'grade_9', 'grade_10', 'grade_11', 'grade_12'], text: 'What matters most to you in a future career?', options: ['Building something tangible and lasting', 'Discovering new knowledge or solving complex problems', 'Expressing creativity and original thinking', 'Helping people grow, heal, or succeed'] },
  { section: 1, type: 'choice', stages: ['grade_8', 'grade_9', 'grade_10', 'grade_11', 'grade_12'], text: 'How do you prefer to solve problems?', options: ['Using tools, prototypes, experiments, or hands-on trial and error', 'Research, data analysis, and logical reasoning', 'Brainstorming creative or unconventional ideas', 'Talking it through with others and reaching consensus'] },
  { section: 1, type: 'choice', stages: ['grade_8', 'grade_9', 'grade_10', 'grade_11', 'grade_12'], text: 'Pick the statement that best describes you:', options: ['I like to see concrete, physical results from my work', 'I enjoy complex intellectual challenges above everything else', 'I value self-expression and originality most', 'I am most fulfilled when I have genuinely helped someone'] },
  { section: 1, type: 'choice', stages: ['grade_8', 'grade_9', 'grade_10', 'grade_11', 'grade_12'], text: 'How do you feel about working with technology in your career?', options: ['I want to build or engineer the technology itself', 'I want to use technology to research and discover', 'I want to use technology as a creative tool', 'Technology is secondary — people and relationships are my focus'] },

  // ── SECTION 3: APTITUDE ── 15 questions ────────────────────
  { section: 2, type: 'scale', stages: ['grade_8', 'grade_9', 'grade_10', 'grade_11', 'grade_12'], text: 'I consider myself strong at maths and logical reasoning.' },
  { section: 2, type: 'scale', stages: ['grade_8', 'grade_9', 'grade_10', 'grade_11', 'grade_12'], text: 'I communicate clearly and confidently, both in writing and speaking.' },
  { section: 2, type: 'scale', stages: ['grade_8', 'grade_9', 'grade_10', 'grade_11', 'grade_12'], text: 'I pick up new computer and technology skills quickly.' },
  { section: 2, type: 'scale', stages: ['grade_8', 'grade_9', 'grade_10', 'grade_11', 'grade_12'], text: 'I am well-organised, detail-oriented, and seldom miss deadlines.' },
  { section: 2, type: 'scale', stages: ['grade_8', 'grade_9', 'grade_10', 'grade_11', 'grade_12'], text: 'I stay calm and focused when working under pressure.' },
  { section: 2, type: 'scale', stages: ['grade_8', 'grade_9', 'grade_10', 'grade_11', 'grade_12'], text: 'I am naturally empathetic and good at reading people\'s emotions.' },
  { section: 2, type: 'scale', stages: ['grade_8', 'grade_9', 'grade_10', 'grade_11', 'grade_12'], text: 'I enjoy taking on leadership roles and feel comfortable with responsibility.' },
  { section: 2, type: 'scale', stages: ['grade_8', 'grade_9', 'grade_10', 'grade_11', 'grade_12'], text: 'I pick up creative or artistic skills (drawing, writing, music) easily.' },
  { section: 2, type: 'scale', stages: ['grade_8', 'grade_9', 'grade_10', 'grade_11', 'grade_12'], text: 'I prefer working independently and am self-motivated without supervision.' },
  { section: 2, type: 'scale', stages: ['grade_8', 'grade_9', 'grade_10', 'grade_11', 'grade_12'], text: 'I am confident presenting my ideas to a group or audience.' },
  ...
  { section: 2, type: 'choice', stages: ['grade_8', 'grade_9', 'grade_10', 'grade_11', 'grade_12'], text: 'How would your close friends most likely describe you?', options: ['Analytical, rational, and logical', 'Creative, expressive, and imaginative', 'Caring, supportive, and empathetic', 'Driven, ambitious, and goal-oriented'] },
  ...
  { section: 2, type: 'choice', stages: ['grade_8', 'grade_9', 'grade_10', 'grade_11', 'grade_12'], text: 'Looking ahead, what do you value most in a future career?', options: ['Financial security and a strong, stable salary', 'Work-life balance, flexibility, and freedom', 'Making a meaningful social impact', 'Status, recognition, and professional achievement'] },
...
// CAPS subjects for the marks dropdown (Grade 8-12)
export const CAPS_SUBJECTS = [
  ...
  // Natural Sciences
  'Natural Sciences Biology', 'Natural Sciences Physics',
  ...
  // Creative Arts
  'Visual Arts', 'Dramatic Arts', 'Music', 'Dance',
]

export const TERMS = ['Term 1', 'Term 2', 'Term 3', 'Term 4']
export const TOTAL_QUESTIONS = QUESTIONS.length  // 55 (49 original + 6 rephrased RIASEC consistency checks)
